...
import 'package:words_dictionary/data/country_flags.dart';
import 'package:words_dictionary/data/language.dart';
import 'package:words_dictionary/data/topic_color_containers.dart';
import 'package:words_dictionary/data/topic_theme.dart';
import 'package:words_dictionary/data/topic_text_service.dart';
...
import 'package:words_dictionary/words_list.dart';
...
class _PrintButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return TextButton(
      ...
      onPressed: wordsLength == 0 ? () {} : model.printWords,
      child: Text('${topicPrintText.translations[modelTopic.topicLanguage]}$wordsLengthString'),
    );
  }
}
